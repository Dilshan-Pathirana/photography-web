      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-24">
          ...
          delay: 0.2
            ...
            <img src={publicUrl('/albums/album-1/2.jpg')} alt="Featured album image" className="relative z-10 w-full h-[320px] sm:h-[420px] lg:h-[600px] object-cover rounded-lg shadow-lg grayscale hover:grayscale-0 transition-all duration-700" loading="lazy" decoding="async" />
          </motion.div>
        </div>
