  ...
  return (
    ...
    >
      <Helmet>
        ...
        <meta
          name="description"
          content="Explore featured photography albums across weddings, events, and portraits. Browse recent work and get in touch for your next project."
        />
      </Helmet>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-stone-600 text-lg leading-relaxed mb-8 font-light">
                Photography is more than just clicking a shutter. It's about observing the
                subtle interactions, the fleeting glances, and the raw emotions that make
                your story unique. Our approach is unobtrusive yet intimate, ensuring we
                document the authentic essence of your special moments.
              </p>
      ...
      <section className="py-24 bg-charcoal text-cream">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="font-display text-4xl md:text-5xl mb-4">Visual Stories</h2>
            <p className="text-stone-400 max-w-2xl mx-auto">
              Glimpses into the beautiful narratives we've had the honor of documenting.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 h-auto md:h-[600px]">
            ...
            >
              <img
                src={publicUrl('/albums/album-1/1.jpg')}
            ...
            <div className="flex flex-col gap-4 h-auto md:h-full">
              ...
              >
                <img
                  src={publicUrl('/albums/album-5/1.jpg')}
                  alt="Featured gallery image"
                  className="w-full h-full object-cover opacity-80 group-hover:opacity-100 transition-opacity duration-500"
                  loading="lazy"
                  decoding="async"
              ...
              >
                <img
                  src={publicUrl('/albums/album-3/1.jpg')}
                  alt="Featured gallery image"
                  className="w-full h-full object-cover opacity-80 group-hover:opacity-100 transition-opacity duration-500"
                  loading="lazy"
                  decoding="async"
          ...
          <div className="text-center mt-12 relative z-10">
            <Link
              to="/albums"
              className="inline-flex items-center gap-2 text-gold hover:text-white transition-colors text-lg font-medium mt-5"
            >
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-6">
          <h2 className="font-display text-4xl text-center mb-16 text-charcoal">Client Love</h2>
